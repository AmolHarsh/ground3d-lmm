...
model = dict(
    ...
    decoder=dict(
        ...
        save_pred_qa_dir='pred_qa_reason3d'),
    criterion=dict(
...
load_from = 'work_dirs/ground3d_reason3d_3d/pytorch_model.pth'  # released HF checkpoint; eval also accepts the ckpt as a CLI arg
