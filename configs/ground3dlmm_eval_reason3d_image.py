...
model = dict(
    ...
    backbone=dict(
        ...
        return_blocks=True),
    decoder=dict(
        type='Grounded_Decoder_Eval_MultiImg',
        num_layers=6,
        ...
        save_pred_qa_dir='pred_qa_reason3d_image',
...
train_pipeline = [
    ...
    dict(
        type='AddSuperPointAnnotations_Reason3D',
        num_classes=num_semantic_classes,
        stuff_classes=[0, 1],
        merge_non_stuff_cls=False),
    dict(type='QA_Generation_Reason3D_Test',
         reason3d_file='data/scannet/oneformer3d_reason3d/reason3d_scannet_train_by_scene.json'),
    dict(
    ...
    dict(
        ...
        transforms=[
            ...
            dict(
                ...
                merge_non_stuff_cls=False),
            dict(type='QA_Generation_Reason3D_Test',
                reason3d_file='data/scannet/oneformer3d_reason3d/reason3d_scannet_val_by_scene.json'),
        ]),
    dict(
        type='Pack3DDetInputs_Reason3D',
        keys=[
...
data_root = 'data/scannet/oneformer3d_reason3d'
# run settings
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        ann_file='reason3d_infos_train.pkl',
        data_root=data_root,
...
val_dataloader = dict(
    dataset=dict(
        type=dataset_type,
        ann_file='reason3d_infos_val.pkl',
        data_root=data_root,
        data_prefix=data_prefix,
...
load_from = 'work_dirs/ground3d_reason3d_image/pytorch_model.pth'  # released HF checkpoint; eval also accepts the ckpt as a CLI arg
